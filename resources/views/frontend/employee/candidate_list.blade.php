...
<div class="row">
    <div class="col-md-4 col-lg-4 mb-3">
{{--        <td><img src="{{asset('uploads/users/'.$candidate->resume)}}" width="75px" height="75px" ></td>--}}
{{--@dd($candidate)--}}
<a href="{{asset('uploads/users/'.$candidate->user->profile->resume)}}"  target="_blank">Resume</a>
        {{--        <button type="button"  class="btn btn-primary"><a  href="{{route('uploads/users/'.$candidate->resume)}}"></a>Resume</button>--}}
    </div>
    <div class="col-md-4 col-lg-4 mb-3">
