            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    ...
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="needs-validation" novalidate action="{{route('candidate_profile_post')}}"
                        ...
                        <div class="form-row">
                            <div class="col-md-5 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" name="fname" id="validationCustom02"
                                       placeholder="First name" value="{{auth()->user()->fname}}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" name="ccity" placeholder="Current City"
                                       id="validationCustom03" required>
                            ...
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" name="pcity" placeholder="Permanent City"
                                       id="validationCustom05" required>
                                <div class="invalid-feedback">
                                    Please provide a valid City.
                                </div>
