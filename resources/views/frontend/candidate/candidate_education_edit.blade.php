...
<p>Qualification:{{$educations->qualification}}</p>
                    ...
                    <form action="{{route('candidate_education_post')}}" method="post">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" value="{{$education->qualification}}" class="form-control" name="qualification" placeholder="e.g B.SC">
                                </div>

                                <div class="col-md-6 mb-3 mb-md-0">
                                    <label for="validationCustom03">Stream</label>
                                    <input type="text" class="form-control" value="{{$education->stream}}" name="stream" placeholder="e.g Science ">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" class="form-control" value="{{$education->institute_name}}" name="institute_name"
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" class="form-control" value="{{$education->percentage}}" name="percentage" placeholder="e.g 0.00">
                                </div>
                            </div>
                        </div>
